...
if __name__ == '__main__':
    ...
    if args.verbose:
        ...
        for coordinate in B.dict_if.keys():
            if 'executed' in B.dict_if[coordinate].keys():
                full_verbose_branch = "Line %d: " % B.dict_if[coordinate]["try_line"] + B.dict_if[coordinate]['verbose']
                list_branch_if.append(
                    (coordinate[0], coordinate[1], B.dict_if[coordinate]['executed'], full_verbose_branch))
            else:
                full_verbose_branch = "Line %d: " % coordinate[0] + B.dict_if[coordinate]['verbose']
                list_branch_if.append((coordinate[0], coordinate[1], B.dict_if[coordinate]['true'],
                                       B.dict_if[coordinate]['false'], full_verbose_branch))
        ...
        for condition_ in list_condition_:
            if condition_[2] > 0:
                list_verbose_condition.append("Line %d: " % (condition_[0]) + condition_[-1] + " ==> True")
            if condition_[3] > 0:
                list_verbose_condition.append("Line %d: " % (condition_[0]) + condition_[-1] + " ==> False")
        list_verbose_condition = sorted(list_verbose_condition)
        for condition_printed in list_verbose_condition:
            print(condition_printed)

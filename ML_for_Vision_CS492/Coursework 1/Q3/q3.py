...
def low_dimension_PCA(X_data, labels):
    ...
    print("time to compute eigenvalues, eigenvectors: ", t1-t0)
    # w.shape =  (416,
    # v.shape =  (416, 416)
...
def merge_2_PCA_models(meanface1,num_img1, s1, P1_transpose, meanface2, num_img2,s2, P2_transpose, M_pca):
    ...
    t3 = time.time()
    print("phi_s3_phi.shape = ", phi_s3_phi.shape)

    print("eigendecomposition time incremental : ", t3-t2)
    # w.shape = (141,)
    # v.shape =  (141, 141)
...
reconstruction_error_for_3_model(100)
